...
statusCode=$(curl --write-out %{http_code} --silent --output /dev/null https://pypi.python.org/pypi/mysql-binlog-explorer/${version})
...
pip uninstall mysql-binlog-explorer -y
